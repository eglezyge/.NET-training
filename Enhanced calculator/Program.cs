...
class Enhanced
{
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine("It has to be a numbner, try again.");
            }
        }
        while (true)
        {
        ...
        while (badChar)
        {
            Console.WriteLine("Enter one of five characters: * / % + or - :");
            ...
            else if (char1 == "/")
            {
                if (num2 == 0)
                {
                    Console.WriteLine("Division by 0 is not possible. Chose another character.");
                    badChar = true;
                }
                else
                {
                    double resultDiv = num1 / num2;
                    Console.WriteLine("You chose division. The resultis: " + resultDiv);
                    break;
                }
            }
            else if (char1 == "%")
            {
                ...
                Console.WriteLine("You chose modulo. The result is: " + resultModulo); 
                break;
            }
            else if (char1 == "+")
            {
                double resultAdd = num1 + num2;
                Console.WriteLine("You chose add. The result: " + resultAdd);
                break;
            }
            else if (char1 == "-")
            {
                double resultSub = num1 - num2;
                Console.WriteLine("You chose sub. The result: " + resultSub);
                break;
            }
            else
            {
                Console.WriteLine("It has to be the right character.");
                badChar = true;
            }
